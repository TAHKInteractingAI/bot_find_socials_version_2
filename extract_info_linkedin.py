...
def search_social_media_profile(platform):
    ...
    try:
                ...
                if "not" in ceo_name:
                    ...
                    if (
                        ...
                        try:
                            ...
                            print(f"Error extracting LinkedIn info: {str(e)}")
                        ...
                        for linkedin_url in profile_links:
                            ...
                            followers = sel.xpath('//*[starts-with(@class, "t-bold")]/text()').extract_first()
                            if followers:
        ...
        for entry in json_data:
            for linkedin_entry in entry.get("LinkedIn Data", []):
                output_sheet.append(
                    [
                        entry["Name"],
                        entry["Company Name"],
