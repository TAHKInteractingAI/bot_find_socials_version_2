...
def login_facebook(driver):
    ...
    username.send_keys("0378681408")  # Thay bằng địa chỉ email của bạn

    password = driver.find_element(By.ID, "pass")
    password.send_keys("nhan2802")  # Thay bằng mật khẩu của bạn
...
def extract_information_facebook(driver, profile_links):
    facebook_data = []
    login_facebook(driver)

    for facebook_url in profile_links:
        ...
        try:
            name_and_company_facebook = sel.css('div.x9f619.x1n2onr6.x1ja2u2z.x78zum5.x2lah0s.xl56j7k.x1qjc9v5.xozqiw3.x1q0g3np.x1l90r2v.x1ve1bff div.x9f619.x1n2onr6.x1ja2u2z.x78zum5.xdt5ytf.xeuugli.x1r8uery.x1iyjqo2.xs83m0k.x1swvt13.x1pi30zi.xqdwrps.x16i7wwg.x1y5dvz6 div.x6s0dn4.x78zum5.xvrxa7q.x9w375v.xxfedj9.x1roke11.x1es02x0 div.x78zum5.x15sbx0n.x5oxk1f.x1jxijyj.xym1h4x.xuy2c7u.x1ltux0g.xc9uqle span.x193iq5w.xeuugli.x13faqbe.x1vvkbs.x1xmvt09.x1lliihq.x1s928wv.xhkezso.x1gmr53x.x1cpjm7i.x1fgarty.x1943h6x.x14qwyeo.xw06pyt.x579bpy.xjkpybl.x1xlr1w8.xzsf02u.x1yc453h h1.x1heor9g.x1qlqyl8.x1pd3egz.x1a2a7pz::text').extract_first()
            followers_facebook = sel.css('a.x1i10hfl.xjbqb8w.x1ejq31n.xd10rxx.x1sy0etr.x17r0tee.x972fbf.xcfux6l.x1qhh985.xm0m39n.x9f619.x1ypdohk.xt0psk2.xe8uvvx.xdj266r.x11i5rnm.xat24cr.x1mh8g0r.xexx8yu.x4uap5.x18d9i69.xkhd6sd.x16tdsg8.x1hl2dhg.xggy1nq.x1a2a7pz.xt0b8zv.xi81zsa.x1s688f:nth-child(1)::text').extract_first()
            following_facebook = sel.css('a.x1i10hfl.xjbqb8w.x1ejq31n.xd10rxx.x1sy0etr.x17r0tee.x972fbf.xcfux6l.x1qhh985.xm0m39n.x9f619.x1ypdohk.xt0psk2.xe8uvvx.xdj266r.x11i5rnm.xat24cr.x1mh8g0r.xexx8yu.x4uap5.x18d9i69.xkhd6sd.x16tdsg8.x1hl2dhg.xggy1nq.x1a2a7pz.xt0b8zv.xi81zsa.x1s688f:nth-child(2)::text').extract_first()

            facebook_data.append({
                "Name And Company Facebook": name_and_company_facebook.strip() if name_and_company_facebook else None,
                "Followers Facebook": followers_facebook.strip() if followers_facebook else None,
                "Following Facebook": following_facebook.strip() if following_facebook else None,
            })
                ...
                for twitter_entry in twitter_data:
                    output_sheet.append(
                        [
                            ...
                            entry["Keywords"],
                            entry[f"{platform} Profile"],
                            "",  # LinkedIn data placeholders
                            "",  # Twitter data placeholders
                            "",  # LinkedIn data placeholders
                            "",  # LinkedIn data placeholders
